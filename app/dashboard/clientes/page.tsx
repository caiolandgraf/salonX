...
export default function ClientesPage() {
  ...
  const getSegmentColor = (segment?: string) => {
    switch (segment) {
      case 'VIP': return 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300';
      case 'REGULAR': return 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300';
      case 'NEW': return 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300';
