  ...
  const fetchReports = async () => {
    try {
      ...
      const response = await fetch(
        `/api/reports?period=${period}&type=${reportType}`
      )
      if (response.ok) {
        ...
        setStats({
          ...
          profitMargin:
            data.summary?.netProfit && data.summary?.totalIncome
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap md:flex-nowrap">
        ...
        <div className="flex gap-2 mt-3 md:mt-0 w-full md:w-auto flex-col md:flex-row">
          <Button
            variant="outline"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-primary mt-2">
                    R${' '}
                    {(stats?.profit || 0).toLocaleString('pt-BR', {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2
                    })}
                  </p>
                ...
                {professionalsData.map((professional, index) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Comissão: R${' '}
                        {professional.comissao.toLocaleString('pt-BR')}
                      </p>
                    </div>
                  </div>
                ))}
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-2xl font-bold text-primary">
                  {(stats?.attendanceRate || 0).toFixed(0)}%
                </p>
                <div className="flex items-center gap-2">
                  <div className="flex-1 bg-muted rounded-full h-2 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min(stats?.attendanceRate || 0, 100)}%`
                      }}
                    />
                  </div>
